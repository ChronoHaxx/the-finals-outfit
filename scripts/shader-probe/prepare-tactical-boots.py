"""Stage the frozen 21-choice Tactical Boots family using the existing source/compiler checks.
...
DOCS = Path('_docs/tactical-boots-2026-09-13')
WORK = Path('scripts/generated/shader-probe/tactical-boots-v1')
RUNTIME = Path('public/models/reconstructed-tactical-boots-v1')
PREVIEW = Path('public/models/reconstructed-tactical-boots-preview-v1')
d.configure(DOCS / 'batch.json', WORK, RUNTIME, PREVIEW)
d.REUSE_EXPORTS, d.REUSE_TEXTURES = [], []
d.MARKER = 'shader-probe/prepare-tactical-boots'
