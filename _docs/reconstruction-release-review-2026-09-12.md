...
- [ ] **4. Nails.** Click Nail Polish and select Nails Crosses 01. Zoom toward a hand, then click the selected tile to remove it and again to restore it. Expect the nail design to disappear/reappear without tinting the fingers or leaving the old design behind.
...
- [ ] **6. Ordinary outfit and sharing.** Click Facewear and select Asian Mask. Use Copy share link, paste the link into a new tab, and refresh it. Expect the selected mask, clothing and cosmetics to return, and camera dragging to remain usable.
